					...
					expr: &zeroOrMoreExpr{
						...
						expr: &choiceExpr{
							...
							alternatives: []any{
								...
								&actionExpr{
									pos: position{line: 267, col: 8, offset: 6408},
									run: (*parser).callonRoot16,
									expr: &seqExpr{
										pos: position{line: 267, col: 8, offset: 6408},
										exprs: []any{
											&anyMatcher{
												line: 267, col: 8, offset: 6408,
											},
											&zeroOrMoreExpr{
												pos: position{line: 267, col: 10, offset: 6410},
												expr: &charClassMatcher{
													pos:        position{line: 267, col: 10, offset: 6410},
													val:        "[^#]",
													chars:      []rune{'#'},
		...
		},
		{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []any{
						&zeroOrMoreExpr{
							pos: position{line: 269, col: 18, offset: 6496},
							expr: &charClassMatcher{
								pos:        position{line: 269, col: 18, offset: 6496},
								val:        "[ \\t\\r\\n]",
								chars:      []rune{' ', '\t', '\r', '\n'},
										...
										&actionExpr{
											...
											expr: &choiceExpr{
												...
												alternatives: []any{
													...
													&litMatcher{
														pos:        position{line: 253, col: 50, offset: 6141},
														val:        "in",
														ignoreCase: true,
														want:       "\"in\"i",
													},
							...
							expr: &zeroOrMoreExpr{
								...
								expr: &seqExpr{
									...
									exprs: []any{
										...
										&actionExpr{
											pos: position{line: 260, col: 16, offset: 6267},
											run: (*parser).callonArithmeticExpr12,
											expr: &charClassMatcher{
												pos:        position{line: 260, col: 17, offset: 6268},
												val:        "[+-/*%]",
												chars:      []rune{'+', '-', '/', '*', '%'},
												ignoreCase: false,
												inverted:   false,
